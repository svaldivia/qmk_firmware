...
[_LOWER] = LAYOUT(
  ...
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, C(KC_LEFT), KC_ASTR, KC_LPRN, C(KC_RIGHT), KC_TILD,
 ...
 * | SLEEP|      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |ctlSpc|   1  | Mute | Vol- | Vol+ |   5  |                    |   6  |WWWBak|PGDwn | PGUp |WWWFwd|      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | HYPR|  F2  | Prev | Play |  FWD |  F6  |-------.    ,-------|ScrolL| Left | Down |  Up  |Right |ScrolR|
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |      |  F8  |  F9  | F10  | F11  | F12  |-------|    |-------|   +  |   -  |   =  |   [  |   ]  |   \  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP| RGUI |
...
[_RAISE] = LAYOUT(
  ...
  LCMD(KC_SPC), KC_1, KC_MUTE, KC_VOLD, KC_VOLU,  KC_5,                     _______, KC_WBAK,  KC_PGDN, KC_PGUP,  KC_WFWD, _______,
  KC_HYPR, KC_F2,   KC_MPRV, KC_MPLY, KC_MNXT,   KC_F6,                     KC_WH_R, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_WH_L,
 ...
 * |Debug |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                    |      |ScrolL|MouseU|ScrolR|ScrolU|      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |Mclick|Lclick|Rclick|      |-------.    ,-------|      |MouseL|MouseD|MouseR|ScrolD|      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |      | MODE | HUE- | SAT- | VAL- |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP| RGUI |
